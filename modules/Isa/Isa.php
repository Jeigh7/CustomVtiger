...
class Isa extends Vtiger_CRMEntity {
        var $table_name = 'vtiger_isa';
        var $table_index= 'isaid';

        var $customFieldTable = Array('vtiger_isacf', 'isaid');

        var $tab_name = Array('vtiger_crmentity', 'vtiger_isa', 'vtiger_isacf');
